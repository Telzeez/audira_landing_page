          ...
          {formSuccess ? (
            ...
            <div className={styles.authPromptCard}>
              <p className={styles.authPromptText}>
                You must be logged in to submit a review for your registered
                devices.
              </p>
      ...
      >
        {reviews.length === 0 ? (
          <div className={styles.card}>
            <div className={styles.emptyReviewCard}>
              <h3>Be the first to share your Audira experience.</h3>
              <p>
                There are no reviews yet. Your feedback will help others
                discover the premium sound and luxury design.
              </p>
              <button
          ...
          reviews.map((t) => (
            <div key={t.id} className={styles.card}>
              ...
              <p className={styles.quoteText}>&quot;{t.quote}&ldquo;</p>
