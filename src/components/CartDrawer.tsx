...
export default function CartDrawer({
  ...
  // Pre-fill form logic moved to the transition point (handleCheckoutClick)
  // and handled via state initialization or derived state where possible.
  // Removed the useEffect that was calling setFormData synchronously.
  ...
  const handleCheckoutClick = () => {
    ...
    if (!user) {
      setAuthMessage("Please log in to proceed with checkout.");
      return;
    }
        ...
        {checkoutStep === "success" ? (
          ...
          <div className={styles.successState}>
            ...
            <p className={styles.successText}>
              Thank you for purchasing from Audira. We've recorded your
              purchase.
            </p>

            <div className={styles.successOrderRefContainer}>
              <div className={styles.successOrderLabel}>
          ...
          <>
            {authMessage && (
              <div className={styles.authRequiredBanner}>
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
                ...
                <button
                  ...
                  onClick={() => {
                    // Option A: call an optional parent callback
                    // if (onAuthRequired) onAuthRequired();
                    // Option B: simple fallback – open a modal or redirect
                    alert(
                      "Sign up / Log in feature – please implement your own flow.",
                    );
                  }}
                >
                  Sign Up / Log In
